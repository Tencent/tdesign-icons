...
export function loadScript(url: string, className: string): void {
  if (typeof document === 'undefined' || !url || typeof url !== 'string') return;
...
export function loadLink(url: string, className: string): void {
  if (typeof document === 'undefined' || !url || typeof url !== 'string') return;
...
export function loadStylesheet(): void {
  ...
  if (typeof document === 'undefined' || document.getElementById(styleSheetId)) return;
